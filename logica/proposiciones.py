...
def _crea_filas_tabla_verdad(variables):
    """
    Devuelve una lista de diccionarios. Cada diccionario tiene como claves
    cada una de las variables y como valor un booleano. La lista abarcará
    todas las combinaciones posibles de valores boolenas de cada variable.
    Argumentos:
    ...
    P = variables[0]
    R = _crea_filas_tabla_verdad(variables[1:])
...
class Proposicion:
    """
    Clase que representa una proposición en lógica de proposiciones.
    """
    ...
    def evaluar(self, **asignaciones):
        ...
        raise NotImplemented("Hay que implementar este método")

    def ver_tabla_verdad(self,
                         maximo=5):
        """
        Muestra la tabla de verdad de la proposición, mostrando todas la
        combinaciones posibles de los valores de sus variables.
        Argumentos:
    ...
    def __rshift__(self, otra):
        """
        Sobrecarga del operador lógico de deplazamiento hacia la derecha, que
    ...
    def __lshift__(self, otra):
        """
        Sobrecarga del operador lógico de deplazamiento hacia la izquierda, que
    ...
    def __eq__(self, otra):
        """
        Sobrecarga del operador igualdad que va a simbolizar una equivalencia
        lógica (doble implicación, 'sí y sólo sí').
        Argumentos:
    ...
    def es_contingente(self):
        """
        Indica si no es tautología ni contradicción, es dedir, si algunas
        combinaciones de valores dan True y otras dan False.
...
class Implica(Proposicion):
    ...
    def __init__(self, premisa, conclusion):
        ...
        """
        # Invocamos al constructor de la clase base.
        super(Implica, self).__init__(premisa, conclusion)
...
class ImplicadoPor(Proposicion):
    ...
    def __init__(self, conclusion, premisa):
        ...
        """
        # Invocamos al constructor de la clase base.
        super(ImplicadoPor, self).__init__(conclusion, premisa)
...
class Equivale(Proposicion):
    ...
    def __init__(self, izquierda, derecha):
        ...
        """
        # Invocamos al constructor de la clase base.
        super(Equivale, self).__init__(izquierda, derecha)
...
class Argumento:
    ...
    def es_valido(self):
        """
        Indica si el razonamiento es válido, es decir, si se puede inferir la
