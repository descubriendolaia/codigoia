        ...
        for nombre_accion in nodo.acciones.keys():
            ...
            if hijo.estado in explorados or hijo.estado in estados_frontera:
                ...
                if buscar:
                    ...
                    # Obtenemos la mejor heurísticas.
                    minimo_hijo = min(hijo.heuristicas.values())
                    minimo_buscar = min(buscar[0].heuristicas.values())
...
def muestra_solucion(objetivo=None,
    ...
    while nodo:
        ...
        msg = "  Heurística: {0}"
        heuristica = min(nodo.heuristicas.values())
